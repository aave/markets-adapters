...
interface MockCpmInterface extends Interface {
  functions: {
...
export class MockCpm extends Contract {
  connect(signerOrProvider: Signer | Provider | string): MockCpm;
  attach(addressOrName: string): MockCpm;
  deployed(): Promise<MockCpm>;

  on(event: EventFilter | string, listener: Listener): MockCpm;
  once(event: EventFilter | string, listener: Listener): MockCpm;
  addListener(eventName: EventFilter | string, listener: Listener): MockCpm;
  removeAllListeners(eventName: EventFilter | string): MockCpm;
  removeListener(eventName: any, listener: Listener): MockCpm;

  interface: MockCpmInterface;
